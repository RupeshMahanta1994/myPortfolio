              ...
              <p>
                <ul>
                  ...
                  <li>
                    ...
                    facilities, classes, trainers, and membership options,
                    promoting a healthy and active lifestyle.
                  </li>
                  <li>The UI-UX of the website is build using CSS3</li>
                </ul>
              </p>
              <a href="https://gymate-b4lh.vercel.app/">
                <Button>
                  live <FaExternalLinkAlt fontSize="1.1rem" />
                </Button>
              </a>
            </div>
          </Card>
            ...
            <div className="CardText">
              ...
              <p>
                <ul>
                  ...
                  <li>
                    The UI is designed using <b>Tailwind CSS</b>
                  </li>
                </ul>
              </p>
              <a href="https://react-car-rental-demo.netlify.app/">
                <Button>
                  live <FaExternalLinkAlt fontSize="1.1rem" />
                </Button>
              </a>
          ...
          <Card>
            ...
            <div className="CardText">
              ...
              <p>
                <ul>
                  <li>
                    AEGIS is a modern frontend website that serves as an
                    innovative content provider platform.
                  </li>

                  <li>
                    Our goal is to bridge the gap between content creators and
                    their target audience by an user friendly interface
                  </li>

                  <li>
                    This website is build using Styled-Components, React and
                    deployed using Github CI/CD pipeline to Vercel.
                  </li>
                </ul>
              </p>
